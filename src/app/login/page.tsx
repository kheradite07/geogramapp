            ...
            <div className="w-full max-w-md p-8 space-y-8 rounded-2xl shadow-2xl backdrop-blur-xl border border-white/10 bg-black/40 pointer-events-auto transition-all hover:bg-black/50">
                ...
                <div className="space-y-4">
                    ...
                    <button
                        ...
                        className="hidden md:flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-black transition-all bg-white/90 rounded-lg hover:bg-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white shadow-lg backdrop-blur-sm"
                    >
                    ...
                    <button
                        ...
                        className="flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white transition-all bg-black/80 rounded-lg hover:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black shadow-lg backdrop-blur-sm border border-white/10"
                    >
